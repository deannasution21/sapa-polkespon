                    ...
                    <div class="col-lg-8">
                        <div class="blog-details-box mb-45">
                            ...
                            <ul class="blogs__meta mb-30">
                                ...
                                <li><span><img src="{{ URL::asset('assets/img/icon/material-access-time.svg') }}"
                                            alt="mate-date"> 03</span></li>
                                <li> <span><img src="{{ URL::asset('assets/img/icon/material-comment.svg') }}"
                                            alt="mate-date"> 5 Min</span></li>
                                <li>
                            ...
                            <img class="img-fluid blog-details-img mb-35"
                                src="{{ URL::asset('assets/img/blog/16.jpg') }}" alt="blog-details-img">
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                ...
                                even slightly believable.There are many variations of passages of Lorem Ipsum available.</p>
                        </div>
                        <div class="blog-quote-box mb-45">
                            ...
                            <div class="quote__text">
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    ...
                                    look even slightly believable. If you are passage of Lorem Ipsum.</p>
                                <h6>- Jason Statham</h6>
                            </div>
                        </div>
                        <div class="blog-details-text mb-30">
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                ...
                                sure there isn't anything embarrassing hidden.There are many variations of passages of Lorem
                                ...
                                passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.</p>
                        </div>
                        <div class="blog-details-text row gx-2 mb-45">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="blog-details-img-box mb-30">
                                    <img class="img-fluid" src="{{ URL::asset('assets/img/blog/17.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="blog-details-img-box mb-30">
                                    <img class="img-fluid" src="{{ URL::asset('assets/img/blog/18.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6">
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                suffered alteration in some form, by injected humour, or randomised words which don't look
                                even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be
                                sure there isn't anything embarrassing hidde.</p>
                        </div>
                        <div class="blog-details-video">
                            <h3 class="blog-details-title mb-30">10 Common Educations Questions and Answers</h3>
                            <p class="mb-30">There are many variations of passages of Lorem Ipsum available, but the
                                majority have suffered alteration in some form, by injected humour, or randomised words
                                which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum,
                                you need to be sure there isn't anything embarrassing hidden.There are many variations of
                            ...
                            <ul class="blog-details-list mt-30">
                                <li>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    ration in some form, by injected humour, or randomised words which don't look even
                        ...
                        <div class="blog-details-gallery row gx-2 mb-45">
                            <div class="col-lg-8 col-md-8">
                                <div class="blog-details-img-box mb-30">
                                    <img class="img-fluid" src="{{ URL::asset('assets/img/blog/21.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="blog-details-img-box mb-30">
                                    <img class="img-fluid" src="{{ URL::asset('assets/img/blog/22.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="latest-commmnet">
                                <li>
                                    <div class="single-comments mb-30">
                                        ...
                                        <div class="comments__text">
                                            <h4 class="sub-title mb-10">Kavin Petersen <span
                                                    class="float-end date-text">21 July , 2021</span></h4>
                                ...
                                <li>
                                    <div class="single-comments">
                                        ...
                                        <div class="comments__text">
                                            <h4 class="sub-title mb-10">Lebron James <span class="float-end date-text">21
                                                    July , 2021</span></h4>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the
                                                majority have suffered alteration in some form, by injected humour, or
                                                randomised words which don't look even slightly believable. If you are going
                                ...
                                <li>
                                    <div class="single-comments mb-30">
                                        ...
                                        <div class="comments__text">
                                            <h4 class="sub-title mb-10">Jason Momoa <span class="float-end date-text">21
                                                    July , 2021</span></h4>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the
                                                majority have suffered alteration in some form, by injected humour, or
                                                randomised words which don't look even slightly believable. If you are going
                                    ...
                                    <ul class="blog-recent-post">
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/24.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/25.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/26.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Lorem Ipsum is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/27.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Ipsum Lorem is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/28.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Lorem Ipsum is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/29.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Ipsum Lorem is simply dummy text</a></h6>
                                            </div>
                            ...
                            <div class="widget mb-50">
                                <div class="blog-categories-widget">
                                    ...
                                    <ul class="blog-recent-post">
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/30.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Lorem Ipsum is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/31.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Ipsum Lorem is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/32.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Lorem Ipsum is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/33.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Ipsum Lorem is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/34.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Lorem Ipsum is simply dummy text</a></h6>
                                            </div>
                                        ...
                                        <li>
                                            <div class="posts mb-20">
                                                <img src="{{ URL::asset('assets/img/blog/35.jpg') }}" alt=""
                                                    class="posts__thumb mb-15">
                                                <p>1st July , 2021</p>
                                                <h6><a href="blog-details">Ipsum Lorem is simply dummy text</a></h6>
                                            </div>
