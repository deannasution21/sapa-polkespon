                ...
                <div class="row align-items-end">
                    <div class="col-lg-12">
                        <div class="page-title-wrapper mb-50">
                            <h1 class="page-title mb-25">Klinik <span class="text-uppercase">{{ ucfirst($page) }}</span>
                            </h1>
                            <div class="breadcrumb-list">
                                <ul class="breadcrumb">
                                    <li><a class="link-khusus" href="{{ url('/') }}">Beranda</a> - <a
                                            class="link-khusus" href="{{ url('/layanan/klinik') }}">Layanan Klinik
                                            Pratama</a> - </li>
                                    <li><a href="#">Klinik <span
                                                class="text-uppercase">{{ ucfirst($page) }}</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-xl-4">
                        <div class="courses-ingredients ms-0 mb-50" style="border: 2px dashed #16b3ac">
                            ...
                            <p class="mb-30">Layanan Klinik Pratama Poltekkes Pontianak merupakan fasilitas kesehatan
                                kampus yang memberikan pelayanan medis dasar bagi mahasiswa, dosen, dan pegawai. Melalui
                                SAPA POLKESPON, pengguna dapat melakukan pendaftaran layanan kesehatan secara online dengan
                            ...
                            <div class="accordion accordion-two" id="accoedion-ex-two">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Klinik Pratama melayani pemeriksaan umum, pengobatan ringan, serta
                                                    konsultasi kesehatan dasar.</li>
                                                <li>Pelayanan diberikan oleh tenaga medis profesional dari Poltekkes
                                                    Pontianak.
                                                </li>
                                                <li>Mahasiswa aktif dapat memanfaatkan layanan tanpa biaya tambahan, sesuai
                                                    ketentuan yang berlaku.</li>
                                                <li>Pendaftaran dilakukan melalui SAPA POLKESPON atau langsung di loket
                                                    Klinik Pratama.</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Mengisi formulir pendaftaran pasien (online/offline).</li>
                                                <li>Melampirkan identitas diri (KTM/KTP).</li>
                                                <li>Menyertakan surat rujukan bila diperlukan (untuk kasus tertentu).</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Senin–Jumat, pukul 08.00–15.00 WIB
                                                (Libur pada hari Sabtu, Minggu, dan tanggal merah nasional)</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Klinik Pratama Poltekkes Pontianak</li>
                                                <li>Email: klinik@poltekkes-pontianak.ac.id</li>
                        ...
                        <div class="comments-form-area mb-45">
                            ...
                            <form id="formSubmit" class="comments-form mb-30">
                                <div class="row mb-3 align-items-center">
                                    <label for="klinik" class="col-sm-3 col-form-label fw-semibold">Nama Klinik</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="klinik" placeholder="Nama Klinik" disabled
                                            value="{{ $page }}" class="text-uppercase">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 align-items-start">
                                    <label for="judul" class="col-sm-3 col-form-label fw-semibold">Keluhan</label>
                                    <div class="col-sm-9">
                                        <textarea name="judul" id="judul" rows="3">Keluhan Anda</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 align-items-center">
                                    <label for="denda" class="col-sm-3 col-form-label fw-semibold">Biaya Pendaftaran
                                        (Rp)</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="denda" placeholder="0" value="15000" disabled>
                                    </div>
                                </div>
                                ...
                                <table id="tableHistory" class="fs-6" style="min-width: 700px;">
                                    ...
                                    <tbody class="small">
                                        <tr>
                                            ...
                                            <td>
                                                Klinik <span class="text-uppercase">{{ $page }}</span>
                                            </td>
                                            <td class="text-end">
                                                Rp 75.421,-
                                            </td>
