    ...
    <main>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-12">
                        <div class="page-title-wrapper mb-50">
                            <h1 class="page-title mb-25">Layanan Katering Mahasiswa</h1>
                            <div class="breadcrumb-list">
                                <ul class="breadcrumb">
                                    <li><a class="link-khusus" href="{{ url('/') }}">Beranda</a> - </li>
                                    <li><a href="#">Layanan Katering Mahasiswa</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        @php
            $mobil = [
                [
                    'id' => 1,
                    'title' => 'Paket Hemat @10.000',
                    'jenis' => 'non_akademik',
                    'icon' => url('/assets/img/course/katering1.jpg'),
                    'harga' => '10.000',
                    'available' => true,
                ],
                [
                    'id' => 2,
                    'title' => 'Paket Kenyang @15.000',
                    'jenis' => 'non_akademik',
                    'icon' => url('/assets/img/course/katering2.jpg'),
                    'harga' => '15.000',
                    'available' => true,
                ],
                [
                    'id' => 3,
                    'title' => 'Paket Bringas @20.000',
                    'jenis' => 'non_akademik',
                    'icon' => url('/assets/img/course/katering3.jpg'),
                    'harga' => '20.000',
                    'available' => true,
                ],
            ];
                ...
                <div class="row">
                    <div class="col-lg-5 col-xl-4 order-2 order-lg-1">
                        <div class="courses-ingredients ms-0 mb-50" style="border: 2px dashed #16b3ac">
                            ...
                            <p class="mb-30">Layanan Katering Poltekkes Pontianak disediakan untuk mahasiswa yang tinggal
                                di asrama maupun di sekitar kampus. Melalui layanan ini, mahasiswa dapat berlangganan paket
                                makan harian dengan menu bergizi dan harga terjangkau.</p>
                            <div class="accordion accordion-two" id="accoedion-ex-two">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Layanan hanya diperuntukkan bagi mahasiswa Poltekkes Kemenkes Pontianak.
                                                </li>
                                                <li>Pemesanan dilakukan secara periodik (mingguan atau bulanan).</li>
                                                <li>Pembayaran dilakukan di awal periode langganan.</li>
                                                <li>Ketidakhadiran mahasiswa tidak dapat menggantikan atau mengurangi biaya
                                                    langganan yang telah dibayarkan.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Langganan akan dimulai pada tanggal yang telah ditentukan oleh mahasiswa
                                ...
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Telepon/WA: 08123884475775</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <div class="z-gallery mb-30 shadow-sm">
                                                ...
                                                <div class="z-gallery__content pb-3">
                                                    <h4 class="sub-title fs-6 mb-2">{{ $val['title'] }}</h4>
                                                    <p class="mb-25 small" style="line-height: normal">Pagi/Siang/Malam.
                                                        Mulai dari 7 hari</p>
            ...
            <div class="modal-content shadow-lg border-0">
                <div class="modal-header" style="background: #16b3ac">
                    <h5 class="modal-title text-white" id="modalSewaLabel">
                        <i class="fas fa-utensil-fork me-2"></i> Langganan Katering
                    </h5>
                ...
                <div class="modal-body">
                    <form id="formSewaMobil">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <h6 class="mb-1">Nomor Langganan:</h6>
                                <p class="fw-bold mb-2" id="bookingNumber">SEWA-20251014-0001</p>
                            </div>
                            <div class="col-md-6 text-md-end">
                                <h6 class="mb-1">Status Langganan:</h6>
                        ...
                        <div class="mb-3 w-100">
                            <h6 class="mb-1">Nama Paket:</h6>
                            <select class="form-select" id="namaPaket" name="namaPaket" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <h6 class="mb-1">Tanggal Langganan Awal:</h6>
                                <input type="date" class="form-control" id="tanggalAwal" name="tanggalAwal" required>
                            </div>
                            <div class="col-md-6">
                                <h6 class="mb-1">Tanggal Langganan Akhir:</h6>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="tujuan" name="tujuan" rows="2"
                                placeholder="Misal: tidak pakai sambal saya alergi pedas, dll" required></textarea>
                        </div>

                        <div class="mb-3">
                            <h6 class="mb-1">Estimasi Biaya:</h6>
                            <h4 class="fw-bold text-success mb-0" id="totalHarga">Rp 110.000 (10 Hari)</h4>
                            <p class="text-muted small">*Biaya akan disesuaikan berdasarkan durasi langganan</p>
                        </div>
                    </form>
                </div>
...
@section('js')
    ...
    <script>
        function showModalSewa(id) {
            // Auto select mobil
            const select = document.getElementById('namaPaket');
