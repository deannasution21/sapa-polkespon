                ...
                <div class="row align-items-end">
                    <div class="col-lg-12">
                        <div class="page-title-wrapper mb-50">
                            <h1 class="page-title mb-25">Legalisir</h1>
                ...
                <div class="row">
                    <div class="col-lg-5 col-xl-4">
                        <div class="courses-ingredients ms-0 mb-50" style="border: 2px dashed #16b3ac">
                            ...
                            <p class="mb-30">Layanan ini disediakan untuk alumni Poltekkes Pontianak yang membutuhkan
                                legalisir dokumen
                                resmi seperti ijazah dan transkrip nilai untuk keperluan administrasi, pendaftaran kerja,
                                studi lanjut, atau kebutuhan lainnya.</p>
                            <div class="accordion accordion-two" id="accoedion-ex-two">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Dokumen yang dapat dilegalisir meliputi ijazah dan transkrip nilai yang
                                                    telah diterbitkan oleh Poltekkes Pontianak.</li>
                                                <li>Proses legalisir hanya dilakukan terhadap dokumen asli yang telah
                                                    diverifikasi.</li>
                                ...
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <ul class="list-disc ms-4">
                                                <li>Fotokopi dokumen yang akan dilegalisir (ijazah/transkrip nilai).</li>
                                                <li>Menunjukkan dokumen asli sebagai pembanding.</li>
                                                <li>Mengisi formulir permohonan legalisir.</li>
                                                <li>Bukti pembayaran (jika ada biaya administrasi).</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item mb-30">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Estimasi waktu penyelesaian 1–3 hari kerja setelah berkas diterima dan
                                                diverifikasi.</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-7 col-xl-8">
                        <div class="comments-form-area mb-45">
                            ...
                            <form id="formSubmit" class="comments-form mb-30">
                                ...
                                <div class="row mb-3 align-items-center">
                                    <label for="legalisir" class="col-sm-3 col-form-label fw-semibold">Jenis
                                        Legalisir</label>
                                    <div class="col-sm-9">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="jenis_legalisir"
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="transkrip_nilai">Transkrip Nilai</label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-primary"
                                                    style="text-transform: unset">nama_file_ijazah.docx</a>
                                            </td>
                                            <td>
                                                <div class="btn-group-vertical" role="group">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-warning">
                                                        <i class="fas fa-hand-paper me-2"></i> Belum Kirim
                                                    </button>
